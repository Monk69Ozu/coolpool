    ...
    <header className={`site-header ${scrolled ? 'is-scrolled' : ''}`}>
      <div className="header-inner">
        ...
        <div className="header-cta">
          <a className="phone-link" href="tel:+436776340572"><Icon.phone /> <span className="phone-text">+43 677 634 0572</span></a>
...
function Footer() {
  return (
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <p style={{ marginTop: 10 }}>
              <a href="tel:+436776340572" style={{ display: 'inline', fontWeight: 600 }}>+43 677 634 0572</a><br/>
              <a href="mailto:Coolpool@gmx.at" style={{ display: 'inline' }}>Coolpool@gmx.at</a>
            </p>
          </div>
        </div>
        <div className="footer-bottom">
          <div>© {new Date().getFullYear()} coolpool – Inhaber: Alex Mück</div>
          <div>
    ...
    <a className="wa-float" href="https://wa.me/436776340572" target="_blank" rel="noopener" aria-label="WhatsApp Chat öffnen">
